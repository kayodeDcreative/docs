  ...
  <Tab title="Real-Time Communication">
    <CardGroup cols={2}>
      ...
      <Card title="Message History" icon="clock-rotate-left">
       ...
       <Card title="In-Widget Feedback" icon="star">
        Collect feedback and ratings directly within the chat widget after a conversation is resolved.
      </Card>
    </CardGroup>
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="Article Uploads" icon="file-arrow-up">
    You and your team can easily upload and manage help articles in a centralized location.
  </Card>
  <Card title="Customer Self-Service" icon="user">
...
<CardGroup cols={2}>
  <Card title="Icon Support" icon="lucide-react">
    You can now add a Lucide icon to each category to help users quickly identify the topic.
  </Card>
  <Card title="Category Descriptions" icon="align-left">
